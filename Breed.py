...
if __name__=='__main__':
    path="F:/vrenv/dog's breed classification"
    #path="dog's breed classification/"
...
labels=[]
for img_id in ids:
    img_id=img_id.split('/')[-1].split(".")[0].split("\\")[2]
    breed_name=list(df_l[df_l["id"]==img_id]["breed"])[0]
   # print(breed_name,"::",img_id)
    lbl_idx=breed2id[breed_name]
